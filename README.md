# my-setup
This repository describes my computer setup (what tools/programs I use, what operating system I use, etc.)
...
6. It's company is employee-owned, no external investors.
8. It's abundance of features
9. It's features are completely optional.
10. It's flexible UI.
